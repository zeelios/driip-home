...
use super::model::{AdjustStock, CreateInventoryItem, InventoryFilter, InventoryItem, UpdateInventoryItem};

pub struct InventoryRepository;

impl InventoryRepository {
    pub async fn list(pool: &PgPool, filter: &InventoryFilter) -> Result<Vec<InventoryItem>, AppError> {
    ...
    pub async fn adjust_stock(pool: &PgPool, id: Uuid, adj: AdjustStock) -> Result<InventoryItem, AppError> {
        sqlx::query_as::<_, InventoryItem>(
            "UPDATE inventory
