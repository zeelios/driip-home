...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'deposit_percentage' => $this->total_after_tax > 0
                ? round(($this->deposit_amount / $this->total_after_tax) * 100, 2)
                : 0,
            'cod_expected_amount' => $this->cod_expected_amount,
            'cod_collected_amount' => $this->cod_collected_amount,
            'cod_collected_at' => $this->cod_collected_at?->toIso8601String(),
            'cod_reconciliation_status' => $this->cod_reconciliation_status,
            'cod_discrepancy_amount' => $this->cod_discrepancy_amount,
