  ...
  <div class="page">
    ...
    <template v-else>
      ...
      <div class="status-banner" :class="`status-banner--${order.status}`">
        <div>
          <p class="status-banner__id">
            #{{ order.id.slice(0, 8).toUpperCase() }}
          </p>
          <p class="status-banner__date">
          ...
          <div class="detail-card">
            ...
            <div class="items-list">
              <div v-for="item in order.items" :key="item.id" class="item-row">
                ...
                <p class="item-price">
                  {{ formatVND(item.unit_price_cents * item.quantity) }}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="detail-card">
            ...
            <div class="totals">
              ...
              <div v-if="order.operational_fee_cents" class="total-row">
                ...
                <span>{{
                  formatVND((order as any).operational_fee_cents)
                }}</span>
              </div>
              <div class="total-row total-row--grand">
                <span>Tổng cộng</span>
                <span>{{
                  formatVND(order.grand_total_cents ?? order.total_cents)
                }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="detail-card">
            ...
            <div class="meta-list">
              ...
              <div class="meta-row">
                ...
                <span class="meta-val">{{
                  formatDateFull(order.updated_at)
                }}</span>
              </div>
            </div>
          </div>
